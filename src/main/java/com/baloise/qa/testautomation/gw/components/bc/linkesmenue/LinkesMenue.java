package com.baloise.qa.testautomation.gw.components.bc.linkesmenue;
...
public class LinkesMenue extends AGWComponent {
  ...
  @ById("AccountGroup:AccountDetailMenuActions")
  private BrElement kontoaktionen;
  
  @ById("AccountGroup:AccountDetailMenuActions:AccountDetailMenuActions_NewPolicy-itemEl")
  private BrElement newpolice;
  
  @ById("PolicyGroup:MenuLinks:PolicyGroup_PolicyDetailPayments")
  private BrElement zahlungszeitplan;
  ...
  public void selectNewPolice() {
	kontoaktionen.click();
	newpolice.click();
  }
  
  public void selectZahlungszeitplan() {
	zahlungszeitplan.click();
  }
